...
/**
 * @desc Returns true if given email address is RFC 822 compatible.
 * @see http://www.iamcal.com/publish/articles/php/parsing_email/
 * @copyright Tim Fletcher https://creativecommons.org/licenses/by-sa/2.5/
 * (3rd party author which is neither related too, nor endorse this software)
 */
