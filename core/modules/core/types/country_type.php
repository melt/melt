    ...
    protected static function getCountryList() {
        ...
        if ($country_names === null) {
            $country_names = array(
                ...
                "CI" => array("CIV", 384, _("Cote d'Ivoire ! Côte d'Ivoire")),
                ...
                "AN" => array("ANT", 530, _("Netherlands Antilles [note 1]")),
                ...
                "PS" => array("PSE", 275, _("Palestinian Territory, Occupied")),
                ...
                "RE" => array("REU", 638, _("Reunion ! Réunion")),
