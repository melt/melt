...
<?php $this->layout->enterSection("head_head"); ?>
    ...
    <script type="text/javascript" src="<?php echo APP_IN_DEVELOPER_MODE? url("/static/cmod/js/twitter-bootstrap-imagegallery/js/load-image.js"): url("/static/cmod/js/twitter-bootstrap-imagegallery/js/load-image.min.js"); ?>"></script>
