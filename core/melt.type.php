...
abstract class Type {
    ...
    /**
     * Returns an array of all type classes in application.
     * Note: This looks up and loads all classes so it's slow the first time
     * it runs.
     * @return array
     */
    public static final function getAllTypes($include_abstract = false) {
        return internal\get_all_classes("type", "types", $include_abstract, "/");
    }
}
